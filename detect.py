...
# 目标物体像素值的标记类别，其中最后一个edge轮廓用255像素值记录
...
def detect_semantic(test_x, test_y):
    ...
    psp_model.load_weights('best_val_accuracy0.90915.h5')
    ...
    for i in range(100):
        ...
        true_semantic = Image.open(test_y[i])
        true_semantic1 = np.array(true_semantic)
        true_semantic1[true_semantic1 == 255] = 0
